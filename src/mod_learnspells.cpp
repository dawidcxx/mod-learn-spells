...
private:
    std::unordered_set<uint32> m_ignoreSpells =
    {
        ...
        50581, 30708, 48076, 62900, 62901, 62902, 59671, 50589, 66906, 66907, 24131, 23455, 23458, 23459, 27803, 27804, 27805, 25329, 48075, 42243, 42244, 42245, 42234, 58432, 58433, 65878, 18848, 49376, 54055, 20647, 42243, 24131, 45470,
    ...
    AdditionalSpellsList m_additionalSpells =
    {
        ...
        {78, {
            {SPELLFAMILY_DRUID, {
                AddSpell{16979} // Feral Charge - Bear
            }}
        }}
    };
